        ...
        <>
            <SafeAreaView style={{flex:1,backgroundColor:colors.card}}>
                <View style={{
                   ...
                   <HeaderStyle1 title={'Credit Note'}/>
                    <ScrollView>
                        ...
                        <View style={[styles.card2,{
                                backgroundColor: colors.cardBg,
                                 ...
                                 <TouchableOpacity style={{ flexDirection:'column' }}>
                                    <Text style={{...FONTS.font,color:colors.title,...FONTS.fontBold,margin:5}}>Return No</Text>
                                    ...
                                    />
                                   <TouchableOpacity style={{ flexDirection:'column' }}>
                                    <Text style={{...FONTS.font,color:colors.title,...FONTS.fontBold,margin:5}}>Date</Text>
                                    <Text style={{...FONTS.font,color:colors.title,...FONTS.fontBold,margin:5}}>14/09/2023</Text>
                                    </TouchableOpacity>
                                </View>
                        ...
                        <View style={[styles.card,{
                                ...
                                <View style={{marginBottom:15,flexDirection:'row',borderWidth:2,borderColor:'grey',borderRadius:8}}>
                                    <CustomInput
                                        inputBorder
                                        value={''}  
                                        ...
                                        onChangeText={(value)=> console.log(value)}
                                    />
                                    <FeatherIcon style={{marginRight:6,alignSelf:'center'}} size={28} color={'blue'} name='calendar'/>
                                </View>
                                <View style={{marginBottom:15,flexDirection:'row',borderWidth:2,borderColor:'grey',borderRadius:8}}>
                                    <CustomInput
                                        inputBorder
